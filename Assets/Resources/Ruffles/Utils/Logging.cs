...
namespace Ruffles.Utils
{
    ...
    public static class Logging
    {
        ...
        /// </summary>
        public static event Action<string> OnInfoLog = (value) => Debug.Log("[INFO] " + value);
        /// <summary>
        /// Occurs when ruffles spits out a warning log.
        /// </summary>
        public static event Action<string> OnWarningLog = (value) => Debug.Log("[WARNING] " + value);
        /// <summary>
        /// Occurs when ruffles spits out an error log.
        /// </summary>
        public static event Action<string> OnErrorLog = (value) => Debug.Log("[ERROR] " + value);
