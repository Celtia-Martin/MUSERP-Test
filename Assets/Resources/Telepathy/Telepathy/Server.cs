    ...
    public class Server : Common
    {
        ...
        void Listen(int port)
        {
            ...
            try
            {
                ...
                listener.Start();
                Console.instance.WriteLine("Server: listening port=" + port);
                ...
                while (true)
                {
                    ...
                    Thread sendThread = new Thread(() =>
                    {
                        ...
                        {
                            Console.instance.WriteLine("Server send thread exception: " + exception);
                        }
                    });
                    ...
                    Thread receiveThread = new Thread(() =>
                    {
                        ...
                        {
                            Console.instance.WriteLine("Server client thread exception: " + exception);
                        }
                    });
            ...
            catch (ThreadAbortException exception)
            {
                ...
                Console.instance.WriteLine("Server thread aborted. That's okay. " + exception);
            }
            catch (SocketException exception)
            {
                // calling StopServer will interrupt this thread with a
                // 'SocketException: interrupted'. that's okay.
                Console.instance.WriteLine("Server Thread stopped. That's okay. " + exception);
            }
            catch (Exception exception)
            {
                // something went wrong. probably important.
                Console.instance.WriteLine("Server Exception: " + exception);
            }
        }
        ...
        public bool Start(int port)
        {
            ...
            Console.instance.WriteLine("Server: Start port=" + port);
        ...
        public void Stop()
        {
            ...
            Console.instance.WriteLine("Server: stopping...");
        ...
        public bool Send(int connectionId, ArraySegment<byte> message)
        {
            ...
            if (message.Count <= MaxMessageSize)
            {
                ...
                if (clients.TryGetValue(connectionId, out ConnectionState connection))
                {
                    ...
                    {
                        // log the reason
                        Console.instance.WriteLine($"Server.Send: sendPipe for connection {connectionId} reached limit of {SendQueueLimit}. This can happen if we call send faster than the network can process messages. Disconnecting this connection for load balancing.");
            ...
            Console.instance.WriteLine("Server.Send: message too big: " + message.Count + ". Limit: " + MaxMessageSize);
            return false;
        }
        ...
        public bool Disconnect(int connectionId)
        {
            ...
            if (clients.TryGetValue(connectionId, out ConnectionState connection))
            {
                // just close it. send thread will take care of the rest.
                connection.client.Close();
                Console.instance.WriteLine("Server.Disconnect connectionId:" + connectionId);
                return true;
            }
            return false;
        }
