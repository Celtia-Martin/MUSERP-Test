    ...
    public class Client : Common
    {
...

        {
            ...
            catch (SocketException exception)
            {
                ...
                Console.instance.WriteLine("Client Recv: failed to connect to ip=" + ip + " port=" + port + " reason=" + exception);
            ...
            catch (Exception exception)
            {
                ...
                Console.instance.WriteLine("Client Recv Exception: " + exception);
            }
        ...
        public void Connect(string ip, int port)
        {
            ...
            {
                Console.instance.WriteLine("Telepathy Client can not create connection because an existing connection is connecting or connected");
                return;
            }
        ...
        public bool Send(ArraySegment<byte> message)
        {
            if (Connected)
            {
                ...
                if (message.Count <= MaxMessageSize)
                {
                    ...
                    {
                        // log the reason
                        Console.instance.WriteLine($"Client.Send: sendPipe reached limit of {SendQueueLimit}. This can happen if we call send faster than the network can process messages. Disconnecting to avoid ever growing memory & latency.");
                ...
                Console.instance.WriteLine("Client.Send: message too big: " + message.Count + ". Limit: " + MaxMessageSize);
                return false;
            }
            Console.instance.WriteLine("Client.Send: not connected!");
            return false;
        }
